...
AWS_STORAGE_BUCKET_NAME = 'success-static'
...
# Database
rds_db_password_key_response = client.get_secret_value(SecretId='')
RDS_DB_PASSWORD = rds_db_password_key_response.get('SecretString') if rds_db_password_key_response else ''
